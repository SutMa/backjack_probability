...
const Game: React.FC = () => {
  ...
  enum Choice {
    ...
    aceEightHCHit = "That was the correct choice! In this scenario, it is better to hit because there are no risk in hitting and the dealer will most likely bust!",
    aceEightHCStand = "That was the wrong choice. In this scenario, it is better to hit because there are no risk in hitting and the dealer will most likely bust!",
    specialTwelveSCHit = "That was the wrong choice. In this scenario, it is better to stand because the dealer's chances of busting are high.",
    specialTwelveSCStand = "That was the correct choice! In this scenario, it is better to stand because the dealer's chances of busting are high.",
    specialTwelveHCHit = "That was the correct choice! In this scenario, it is better to hit because the dealer's chances of busting are extremely low so it is better to hit and take your chances!",
    specialTwelveHCStand = "That was the wrong choice. In this scenario, it is better to hit because the dealer's chances of busting are extremely low so it is better to hit and take your chances!",
    specialTeensSCHit = "That was the wrong choice. In this scenario, it is better to stand because the dealer's chances of busting are extremely high.",
    specialTeensSCStand = "That was the correct choice! In this scenario, it is better to stand because the dealer's chances of busting are extremely high.",
    specialTeensHCHit = "That was the correct choice! In this scenario, it is better to hit because the dealer's chances of winning are high so it is better to hit and take your chances.",
    specialTeensHCStand = "That was the wrong choice. In this scenario, it is better to hit because the dealer's chances of winning are high so it is better to hit and take your chances.",
  }
